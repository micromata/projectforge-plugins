...
@Entity
@Indexed
@Table(name = "T_PLUGIN_JMEMO", indexes = [javax.persistence.Index(name = "idx_fk_t_plugin_jmemo_owner_fk", columnList = "owner_fk"), javax.persistence.Index(name = "idx_fk_t_plugin_jmemo_tenant_id", columnList = "tenant_id")])
open class JMemoDO : AbstractBaseDO<Int>() {

    @PropertyInfo(i18nKey = "id")
    private var id: Int? = null

    @PropertyInfo(i18nKey = "plugins.jmemo.subject")
    @Field
    @get:Column(length = Constants.LENGTH_TITLE)
    open var subject: String? = null

    @PropertyInfo(i18nKey = "plugins.jmemo.owner")
    @get:ManyToOne(fetch = FetchType.LAZY)
    @get:JoinColumn(name = "owner_fk")
    open var owner: PFUserDO? = null

    @PropertyInfo(i18nKey = "plugins.jmemo.memo")
    @Field
